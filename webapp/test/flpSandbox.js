		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "[MM]수불부 업데이트",
									"targetURL": "#comdinemmzmm0002-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comdinemmzmm0002-display": {
								"semanticObject": "comdinemmzmm0002",
								"action": "display",
								"description": "[MM]수불부 업데이트",
								"title": "[MM]수불부 업데이트",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.dine.mm.zmm0002",
									"url": sap.ui.require.toUrl("com/dine/mm/zmm0002")
								}
							}
						}
					}
